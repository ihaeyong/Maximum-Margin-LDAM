...
from utils import *
from imbalance_tiny_imagenet import IMBALANCE_TINY_IMAGENET,TinyImageFolder
...
parser.add_argument('--dataset', default='tiny', help='dataset setting')
...
def main():
    ...
    args.root_log = '/'.join([args.root_log, args.dataset, args.imb_type])
    args.root_log = '_'.join([args.root_log, str(args.imb_factor)])
